...
| 센서 | 조도 | **Grove Light Sensor (P) v1.1 [101020173]** | 10,000 | 18 | 180,000 | [디바이스마트 검색](https://www.devicemart.co.kr/goods/search?keyword=Grove+Light+Sensor) |
| 배선 | Grove 4핀 케이블 20cm (SHT40 + Light Sensor 둘 다) | 5pcs 팩 | 5,000 | 9 | 45,000 | [디바이스마트 검색](https://www.devicemart.co.kr/goods/search?keyword=Grove+Universal+4+pin+cable+20cm) |
...
| Grove Light Sensor (P) v1.1 예비 | 10,000 | 2 | 20,000 |
...
- 조도 센서: **Grove Light Sensor (P) v1.1 [101020173] (아날로그 LS06-S)** 사용 확정. BH1750(I2C) 계획 폐기.
  - 펌웨어: I2C(0x23) 제거 → ADC(GP26) 신설, 측정값 lux → 0~100% 상대 밝기
  - 배선: Grove-점퍼 변환 케이블 불필요 (양쪽 Grove 커넥터 단일 케이블)
  - Shield 전원 스위치 **3.3V 필수** (5V면 Pico ADC 손상)
...
| 발주처 | 주문 항목 |
|---|---|
| **디바이스마트** | SHT40, **Grove Light Sensor (P) v1.1**, Grove 4핀 케이블, 마이크로 USB, **Pi 5 16GB**, **Pi 5 액티브 쿨러 케이스·27W 어댑터**, microHDMI, ABS 박스 |
