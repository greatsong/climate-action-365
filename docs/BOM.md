...
| 서버 | Raspberry Pi 4 (4GB) | 정품 | 100,000 | 1 | 100,000 | [디바이스마트](https://www.devicemart.co.kr/goods/view?no=12234534) |
...
| 서버 | Pi4 알루미늄 케이스 | 일반 알루미늄 | 10,000 | 1 | 10,000 | [디바이스마트 검색](https://www.devicemart.co.kr/goods/search?keyword=%EB%9D%BC%EC%A6%88%EB%B2%A0%EB%A6%AC%ED%8C%8C%EC%9D%B44+%EC%BC%80%EC%9D%B4%EC%8A%A4) |
| 서버 | Pi4 5V/3A USB-C 어댑터 | [SZH-PSU04] | 10,000 | 1 | 10,000 | [디바이스마트](https://www.devicemart.co.kr/goods/view?no=12234996) |
...
| 권장 예비 | 약 59,800 |
| **합계 (필수+예비)** | **약 615,500** |
| 예산 상한 (60만) 대비 | **약 +15,500 초과** ⚠️ |

## 예산 60만원에 맞추는 조정 옵션

다음 중 하나만 선택해도 60만 안에 들어옴:

| 옵션 | 절감액 | 영향 |
|---|---|---|
| **microSD 예비 1개 빼기** | -15,000 | Pi가 죽을 확률 낮음. 가장 무난한 절감. |
| USB 어댑터를 멀티포트 충전기로 (예: 6포트 ×3개) | -10,000~20,000 | 콘센트 정리도 됨 |
| Pi4 4GB 대신 2GB | -25,000 | Phase 2/3 확장 시 RAM 부담 |
...
- Pi4 가격 80,000 → 100,000 (정품 시세 반영)
- Pi4 케이스: Argon Neo 25,000 → 일반 알루미늄 10,000
- 모든 부품 URL 추가
...
| 발주처 | 주문 항목 |
|---|---|
| **디바이스마트** | SHT40, BH1750, Grove 케이블 ×2종, 마이크로 USB, Pi4, Pi4 케이스·어댑터·HDMI, ABS 박스 |
