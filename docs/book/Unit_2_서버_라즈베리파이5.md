...
class Reading(BaseModel):
    ...
    light: Optional[float] = None        # 0~100% 상대 밝기 (Phase 1)
...
.mode column
.headers on
SELECT node_id, received_at, temperature, humidity, light FROM readings ORDER BY received_at DESC LIMIT 20;
.quit
```
